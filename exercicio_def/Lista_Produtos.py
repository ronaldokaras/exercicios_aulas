def lista_produtos_unicos(*lista_estoque):
    produtos = set()
    for lista in lista_estoque:
        for produto, _ in lista:
            produtos.add(produto)
    return list(produtos)

estoque_fim_jan = [
    ('BSA2199',396),('PPF5239',251),('BSA1212',989),('PPF2154',449),('BEB3410',241),
...
estoque_fim_fev = [
    ('BSA2199',849),('PPF5239',877),('BSA1212',336),('PPF2154',714),('BEB3410',834),
...
estoque_fim_mar = [
    ('BSA2199',772),('PPF5239',394),('BSA1212',409),('PPF2154',473),('BEB3410',831),
...
estoque_fim_abr = [
    ('BSA2199',647),('PPF5239',292),('BSA1212',551),('PPF2154',802),('BEB3410',712),
...
produtos_total = lista_produtos_unicos(estoque_fim_jan, estoque_fim_fev, estoque_fim_mar, estoque_fim_abr)

print(f"Total de produtos únicos: {len(produtos_total)}")
print("Lista de produtos:", sorted(produtos_total))  